...
const translations = {
  ...
  "faq.a1": { en: "Everlake is currently in the late stages of construction. We will begin hosting in April 2026.", es: "Everlake está actualmente en las últimas etapas de construcción. Comenzaremos a recibir huéspedes en abril de 2026." },
  "faq.q2": { en: "Where is Everlake located?", es: "¿Dónde está ubicado Everlake?" },
  "faq.a2": { en: "Everlake is built on 110 acres in Covington, Georgia — just 1 hour from Atlanta's Hartsfield-Jackson Airport. Nestled in the woods beside two different bodies of water.", es: "Everlake está construido en 110 acres en Covington, Georgia — a solo 1 hora del Aeropuerto Hartsfield-Jackson de Atlanta. Ubicado en el bosque junto a dos cuerpos de agua." },

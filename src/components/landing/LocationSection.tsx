  ...
  return (
    <section className="bg-background py-24 md:py-36 px-8 md:px-16">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
        ...
        >
          <p className="font-body text-xs tracking-[0.25em] uppercase text-everlake-moss mb-4 md:mb-4">{t("loc.badge")}</p>
          ...
          <p className="font-body text-muted-foreground text-[15px] md:text-base leading-[1.65] md:leading-relaxed mb-8" dangerouslySetInnerHTML={{ __html: t("loc.subtitle") }} />
